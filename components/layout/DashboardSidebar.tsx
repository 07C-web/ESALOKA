...
const mitraNav = [
  ...
  {
    href: "/dashboard/mitra/riwayat",
    label: "Riwayat pengumpulan",
    icon: Package,
  },
  {
    href: "/dashboard/mitra/konversi",
    label: "Hasil konversi",
    icon: RefreshCw,
    minTier: "growth",
  },
  {
    href: "/dashboard/mitra/esg",
    label: "ESG metrics",
    icon: Leaf,
    minTier: "growth",
  },
  {
    href: "/dashboard/mitra/insight",
    label: "Insight mendalam",
    icon: TrendingUp,
    minTier: "impact",
  },
  {
    href: "/dashboard/mitra/sertifikat",
    label: "Sertifikat & badge",
    icon: Award,
  },
  {
...
const adminNav = [
  ...
  {
    href: "/dashboard/admin/input",
    label: "Input data operator",
    icon: ClipboardList,
  },
  {
    href: "/dashboard/admin/biokonversi",
    label: "Input biokonversi",
    icon: Bug,
  },
...
export function DashboardSidebar({
  ...
  const navItems =
    role === "admin" ? adminNav : role === "dlh" ? dlhNav : mitraNav;
